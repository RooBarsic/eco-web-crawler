...
public class RequestTelegramBotCommand extends DefaultAbsSender implements TelegramBotCommand {
    private final String botToken;
    private final SearchEngine searchEngine;

    public RequestTelegramBotCommand(DefaultBotOptions options, final String botToken, final SearchEngine searchEngine) {
        super(options);
    ...
    public TelegramBotCommand copyThis() {
        return new RequestTelegramBotCommand(getOptions(), botToken, searchEngine);
    }
